...
export default function HealthcarePage() {
  return (
    <div className="space-y-16 py-12">
      <section className="rounded-3xl border border-slate-200/70 bg-gradient-to-br from-emerald-50 via-white to-sky-50 p-8 shadow-[0_10px_30px_rgba(2,6,23,0.06)] sm:p-12">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            <h1 className="mt-5 text-balance text-4xl font-semibold tracking-tight text-slate-900 sm:text-5xl">
              Healthcare software & AI solutions that reduce operational friction
            </h1>
            <p className="mt-4 max-w-xl text-pretty text-base leading-7 text-slate-600 sm:text-lg">
              PSV Enterprises helps healthcare teams automate documentation, streamline patient workflows, and
              unlock insights from clinical and operational data—built with privacy, security, and compliance in mind.
            </p>
            ...
            <ul className="mt-7 grid gap-3 text-sm text-slate-700 sm:grid-cols-2">
              {[
                ...
                <li key={t} className="flex gap-2 rounded-2xl border border-slate-200/70 bg-white/70 p-4">
