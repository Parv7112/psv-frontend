  ...
  return (
    <div className="space-y-16 py-12">
      <PageHero
        ...
        title="Finance software that improves control, reporting, and operational efficiency"
        description="PSV Enterprises builds secure internal systems, dashboards, and automation for finance teams so they can reduce manual work, improve visibility, and operate with stronger controls."
        actions={
          <>
