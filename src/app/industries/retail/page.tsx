  ...
  return (
    <div className="space-y-16 py-12">
      <PageHero
        ...
        title="Retail software that improves conversion, speed, and operations"
        description="PSV Enterprises builds modern storefronts and operational systems—catalog search, checkout, fulfillment workflows, and analytics—optimized for performance and reliability."
        actions={
          <>
