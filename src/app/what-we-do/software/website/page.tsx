  ...
  return (
    <div className="space-y-20">
      <PageHero
        breadcrumb={
          <nav className="text-sm">
            ...
            <span className="mx-2">/</span>
            <span className="text-zinc-300">Website Development Company</span>
          </nav>
        }
        eyebrow="Software Development"
        title="Website Development Company"
        description="We design and develop websites that are fast, beautiful, and built to convert. From corporate brochure sites and landing pages to CMS-powered portals and eCommerce storefronts, we craft digital presences that reflect your brand and drive measurable results."
        actions={
          <ButtonLink
            href="/lets-talk"
            variant="primary"
      ...
      <section className="relative z-10 -mt-10 rounded-3xl border border-slate-200/70 bg-slate-100/60 p-8 pt-2 shadow-[0_10px_30px_rgba(2,6,23,0.06)] sm:p-12">
        <div className="mx-auto max-w-xl overflow-hidden rounded-2xl border border-slate-200/70 bg-white shadow-[0_4px_20px_rgba(2,6,23,0.08)]">
            {/* Browser chrome */}
