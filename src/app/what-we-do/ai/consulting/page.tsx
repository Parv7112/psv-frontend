  ...
  return (
    <div className="space-y-16 py-12">
      <PageHero
        ...
        title="AI Consulting"
        description="Transform your business with strategic AI consulting. We help you identify opportunities, design solutions, and implement AI that delivers measurable results."
        actions={
          <>
